...
class _MapScreenState extends ConsumerState<MapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Report Hazard FAB — glowing cyan ring
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          child: const Icon(Icons.camera_alt, color: AppColors.cyan),
        ),
      ),
  ...
  Widget _buildMapView(UserLocation location) {
    ...
    return Stack(
      children: [
        ...
        // Destination mode overlay
        if (_destinationMode)
          Positioned(
            top: 100,
            left: 16,
            right: 16,
            child: GlassmorphismDecoration.blurWrap(
              child: Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.touch_app, color: AppColors.cyan),
          ...
          Positioned(
            ...
            child: GlassmorphismDecoration.blurWrap(
              child: Container(
                ...
                decoration: GlassmorphismDecoration.card(
                  borderColor: AppColors.hazardRed.withOpacity(0.4),
                ),
                child: Row(
                  children: [
                    Icon(Icons.error_outline, color: AppColors.hazardRed),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Text(
        ...
        // Set destination / clear route button
        Positioned(
          bottom: selectedRoute != null ? 280 : 100,
          right: 16,
          child: Column(
              ...
              if (selectedRoute == null)
                Container(
                  ...
                  child: FloatingActionButton.extended(
                    ...
                    icon: const Icon(Icons.navigation, color: AppColors.darkBg),
                    label: const Text(
                      'Set destination',
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: AppColors.hazardRed.withOpacity(0.25),
                      blurRadius: 20,
                      spreadRadius: 3,
                    ),
                  ],
                ),
                child: Icon(Icons.location_off, size: 64, color: AppColors.hazardRed),
              ),
              const SizedBox(height: 24),
              Text(
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.gps_off, size: 64, color: AppColors.warningAmber),
              ),
              const SizedBox(height: 24),
              Text(
                'GPS is Turned Off',
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.error_outline, size: 64, color: AppColors.hazardRed),
              ),
              const SizedBox(height: 24),
              Text(
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? AppColors.neonGreen.withOpacity(0.15) : null,
          borderRadius: BorderRadius.circular(24),
        ),
        child: Text(
          label,
